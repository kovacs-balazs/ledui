...
export default function BottomMenu({ children, className = '' }: BottomMenuProps) {
    ...
    return (
        <div className={`w-full ${className} justify-center`}>
            {/* Toggle Button */}
            {/* {(!isOpen || isOpen) && ( */}
                <button
                    className="z-50 w-14 h-14 mx-auto rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg flex items-center justify-center transition-all duration-400 ease-ot"
                    style={{
                        // bottom: isOpen ? '120px' : '100px',
                ...
                >
                    ...
                    <svg fill="#FFFFFF" height="38" width="38" version="1.1" id="Layer_1"
                        viewBox="0 0 323.265 323.265">
                        <g>
                            <g>
                                <g>
            ...
            {/* Backdrop (optional but recommended for UX) */}
            {isOpen && (
                <div
            ...
            {/* Menu */}
            <div
                className={`fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-40 bg-neutral-900/95 backdrop-blur-md border border-neutral-800 rounded-2xl transition-all duration-400 ease-out max-w-md w-fit ${isOpen ? 'opacity-100' : 'opacity-0'}`}
