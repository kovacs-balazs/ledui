import { ReverseWaveAnimation } from "../../utils/types";
...
interface WaveAnimationComponentProps {
    // ledStrip: LedStrip;
    animation: ReverseWaveAnimation;
    onChange: (animation: ReverseWaveAnimation) => void;
}

export default function ReverseWaveAnimationComponent({
    // ledStrip,
    animation,
    onChange,
